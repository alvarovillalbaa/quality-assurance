...
referenceFiles:
  - 'references/typescript-e2e/common/knowledge.md'
  - 'references/typescript-e2e/common/nestjs-setup.md'
...
- `references/typescript-e2e/common/knowledge.md` - Understand E2E fundamentals and test pyramid
- `references/typescript-e2e/common/nestjs-setup.md` - Project structure and Jest configuration
- `references/typescript-e2e/common/rules.md` - Mandatory patterns (GWT, timeouts, isolation)
...
- **Kafka**: `references/typescript-e2e/kafka/docker-setup.md`, `references/typescript-e2e/kafka/knowledge.md`
- **PostgreSQL**: `references/typescript-e2e/postgres/knowledge.md`
- **MongoDB**: `references/typescript-e2e/mongodb/docker-setup.md`, `references/typescript-e2e/mongodb/knowledge.md`
- **Redis**: `references/typescript-e2e/redis/docker-setup.md`, `references/typescript-e2e/redis/knowledge.md`
- **API**: `references/typescript-e2e/api/knowledge.md`
