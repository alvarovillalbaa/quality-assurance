...
- `references/typescript-e2e/common/debugging.md` — for troubleshooting if verification fails
...
1. `references/typescript-e2e/common/rules.md` - Mandatory patterns they must follow
2. `references/typescript-e2e/common/best-practices.md` - Test design guidelines
