...
referenceFiles:
  - 'references/typescript-e2e/kafka/docker-setup.md'
  - 'references/typescript-e2e/mongodb/docker-setup.md'
  - 'references/typescript-e2e/redis/docker-setup.md'
---
...
- `references/typescript-e2e/kafka/docker-setup.md` — Redpanda/Kafka Docker configs
- `references/typescript-e2e/mongodb/docker-setup.md` — MongoDB Docker config
- `references/typescript-e2e/redis/docker-setup.md` — Redis Docker config
