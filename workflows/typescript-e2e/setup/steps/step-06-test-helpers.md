...
referenceFiles:
  - 'references/typescript-e2e/kafka/test-helper.md'
  - 'references/typescript-e2e/postgres/test-helper.md'
  - 'references/typescript-e2e/mongodb/test-helper.md'
  - 'references/typescript-e2e/redis/test-helper.md'
  - 'references/typescript-e2e/api/test-helper.md'
---
...
- `references/typescript-e2e/kafka/test-helper.md` — KafkaTestHelper implementation
- `references/typescript-e2e/postgres/test-helper.md` — PostgresTestHelper implementation
- `references/typescript-e2e/mongodb/test-helper.md` — MongoDbTestHelper implementation
- `references/typescript-e2e/redis/test-helper.md` — RedisTestHelper implementation
- `references/typescript-e2e/api/test-helper.md` — Auth and Supertest helpers
