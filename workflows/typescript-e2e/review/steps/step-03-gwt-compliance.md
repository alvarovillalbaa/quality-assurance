...
- `references/typescript-e2e/common/rules.md` — GWT pattern rules
- `references/typescript-e2e/common/test-case-creation-guide.md` — GWT templates for all scenarios
