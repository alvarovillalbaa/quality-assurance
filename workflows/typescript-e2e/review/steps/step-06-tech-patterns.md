...
referenceFiles:
  - 'references/typescript-e2e/kafka/rules.md'
  - 'references/typescript-e2e/kafka/isolation.md'
  - 'references/typescript-e2e/postgres/rules.md'
  - 'references/typescript-e2e/mongodb/rules.md'
  - 'references/typescript-e2e/redis/rules.md'
  - 'references/typescript-e2e/api/rules.md'
---
...
- **Kafka**: `references/typescript-e2e/kafka/rules.md`, `references/typescript-e2e/kafka/isolation.md`
- **PostgreSQL**: `references/typescript-e2e/postgres/rules.md`
- **MongoDB**: `references/typescript-e2e/mongodb/rules.md`
- **Redis**: `references/typescript-e2e/redis/rules.md`
- **API**: `references/typescript-e2e/api/rules.md`
