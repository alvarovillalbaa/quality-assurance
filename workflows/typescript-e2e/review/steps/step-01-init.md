...
referenceFiles:
  ...
  - 'references/typescript-e2e/common/examples.md'
---
...
- `references/typescript-e2e/common/rules.md` - Mandatory patterns to enforce
- `references/typescript-e2e/common/best-practices.md` - Quality standards
- `references/typescript-e2e/common/examples.md` - Reference implementations
...
- **Kafka tests**: `references/typescript-e2e/kafka/rules.md`, `references/typescript-e2e/kafka/isolation.md`
- **PostgreSQL tests**: `references/typescript-e2e/postgres/rules.md`
- **MongoDB tests**: `references/typescript-e2e/mongodb/rules.md`
- **Redis tests**: `references/typescript-e2e/redis/rules.md`
- **API tests**: `references/typescript-e2e/api/rules.md`
