...
- `references/typescript-e2e/common/rules.md` — to verify all findings are properly categorized
...
1. Re-read `references/typescript-e2e/common/rules.md` if many GWT violations
2. Re-read technology-specific guides if patterns incorrect
3. Review `references/typescript-e2e/common/examples.md` for reference implementations
