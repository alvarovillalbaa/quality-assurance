...
1. `references/typescript-e2e/common/best-practices.md` - Add new patterns discovered
2. `references/typescript-e2e/kafka/performance.md` - Update Kafka-specific optimizations
