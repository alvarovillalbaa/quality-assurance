...
- `references/typescript-e2e/common/best-practices.md` - Performance patterns
- `references/typescript-e2e/common/knowledge.md` - Test lifecycle understanding
- `references/typescript-e2e/common/rules.md` - Ensure optimizations don't violate rules
...
- **Kafka**: `references/typescript-e2e/kafka/performance.md` - Kafka-specific optimizations
- **Database**: `references/{postgres|mongodb}/rules.md` - Query optimization
- **API**: `references/typescript-e2e/api/rules.md` - Request optimization
