...
1. Review `references/typescript-e2e/common/debugging.md` for systematic debugging
2. Review technology-specific guides for common issues
3. Check `references/typescript-e2e/common/examples.md` for correct patterns
