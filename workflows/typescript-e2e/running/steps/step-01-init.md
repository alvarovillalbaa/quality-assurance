...
- `references/typescript-e2e/common/knowledge.md` - Understand test lifecycle
- `references/typescript-e2e/common/debugging.md` - Command line debugging and log analysis
- `references/typescript-e2e/common/nestjs-setup.md` - Configuration verification
