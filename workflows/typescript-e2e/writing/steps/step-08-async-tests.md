...
referenceFiles:
  ...
  - 'references/typescript-e2e/kafka/examples.md'
---
...
- `references/typescript-e2e/kafka/isolation.md` — pre-subscription pattern details
- `references/typescript-e2e/kafka/rules.md` — Kafka-specific testing rules
- `references/typescript-e2e/kafka/examples.md` — Kafka test examples
