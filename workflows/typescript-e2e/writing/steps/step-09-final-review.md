...
- `references/typescript-e2e/common/rules.md` — verify compliance
- `references/typescript-e2e/common/examples.md` — compare with reference implementations
...
1. `references/typescript-e2e/common/examples.md` - Verify patterns match examples
2. Technology-specific `examples.md` - Compare with reference implementations
3. `references/typescript-e2e/common/debugging.md` - For when tests fail
