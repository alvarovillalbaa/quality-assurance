...
referenceFiles:
  - 'references/typescript-e2e/common/rules.md'
  - 'references/typescript-e2e/common/test-case-creation-guide.md'
  - 'references/typescript-e2e/common/best-practices.md'
---
...
- `references/typescript-e2e/common/rules.md` - GWT pattern, timeout rules, isolation requirements
- `references/typescript-e2e/common/test-case-creation-guide.md` - Templates for all scenarios
- `references/typescript-e2e/common/best-practices.md` - Test design patterns
...
- **Kafka tests**: `references/typescript-e2e/kafka/rules.md`, `references/typescript-e2e/kafka/isolation.md`, `references/typescript-e2e/kafka/examples.md`
- **PostgreSQL tests**: `references/typescript-e2e/postgres/rules.md`, `references/typescript-e2e/postgres/examples.md`
- **MongoDB tests**: `references/typescript-e2e/mongodb/rules.md`, `references/typescript-e2e/mongodb/examples.md`
- **Redis tests**: `references/typescript-e2e/redis/rules.md`, `references/typescript-e2e/redis/examples.md`
- **API tests**: `references/typescript-e2e/api/rules.md`, `references/typescript-e2e/api/examples.md`, `references/typescript-e2e/api/mocking.md`
