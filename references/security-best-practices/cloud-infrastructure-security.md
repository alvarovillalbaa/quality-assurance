...
This reference covers cloud infrastructure, CI/CD pipelines, and deployment security. Load it when deploying to cloud platforms, configuring IAM, setting up CI/CD, or managing secrets in cloud environments.
...
## 6. CDN & Edge Security (Cloudflare / Vercel)
...
# - OWASP Core Ruleset
# - Platform Managed Ruleset (Cloudflare or Vercel Firewall)
# - Rate limiting rules
# - Bot protection
```
...
- [ ] **CDN/WAF**: WAF enabled with OWASP rules
