...
For automated multi-ecosystem scanning, see [scripts/dependency_auditor.py](../scripts/dependency_auditor.py).
...
For SSRF payloads and bypass techniques, see [references/attack-patterns.md](./attack-patterns.md#ssrf-detection-techniques).
